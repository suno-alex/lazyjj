...
impl Default for LogTabKeybinds {
    fn default() -> Self {
        ...
        set_keybinds!(
            ...
            LogTabEvent::Sign => "v",
            LogTabEvent::EditRevset => "l",
            LogTabEvent::FetchRebaseSelected => "r",
            ...
            event_push(true, false) => "ctrl+shift+p",
...
impl LogTabKeybinds {
    ...
    pub fn make_main_panel_help(&self) -> Vec<(String, String)> {
        make_keybinds_help!(
            ...
            LogTabEvent::CreateNew { describe: true } => "new change (prompts for description)",
            LogTabEvent::CreateNew { describe: false } => "new change without description",
            ...
            LogTabEvent::FetchRebaseSelected => "git fetch and rebase the selected change onto main",
